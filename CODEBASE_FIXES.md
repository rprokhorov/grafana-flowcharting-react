...
> **Статус (обновлено 2026-06-06):** все пункты **P0 и P1 закрыты** — 12 «чистых» багов
> (с хешами коммитов) и 5 реализованных фич (LinkMap, CSV-источник, date thresholds,
> map options в UI, EventMap/TextMap modes). Остаются только пункты **P2** (бэклог) —
> помечены `[ ]`.
